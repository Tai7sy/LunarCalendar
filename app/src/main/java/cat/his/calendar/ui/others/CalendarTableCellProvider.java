package cat.his.calendar.ui.others;
...
public class CalendarTableCellProvider {
	...
	View getView(int position, LayoutInflater inflater, ViewGroup container) {
		ViewGroup rootView;
		...
		if (position % 8 == 0){
			...
			TextView txtWeekIndex = rootView.findViewById(R.id.txtWeekIndex);
		...
		TextView txtCellGregorian = rootView.findViewById(R.id.txtCellGregorian);
		TextView txtCellLunar = rootView.findViewById(R.id.txtCellLunar);
